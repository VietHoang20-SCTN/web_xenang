...
// Cloudinary SDK auto-reads CLOUDINARY_URL from process.env.
// If individual credentials are provided, use those instead.
...
/**
 * Upload an about section image to Cloudinary (wide banner, high quality).
 */
async function uploadAboutImage(buffer) {
  return uploadImage(buffer, {
    width: 1200,
    height: 800,
    quality: 88,
